...
def print_credits():
    ...
    table.add_row("Mohd Saifulla", "160519733016")
    table.add_row("Syed Mahmood", "160519733053")
    table.add_row("Mohd Subhan Khan", "160519733060")
    console.print(table)
...
if __name__ == "__main__":
    ...
    cprint(figlet_format('cypher!', font='starwars'),'yellow', attrs=['bold'])
    print_credits()
    print()
